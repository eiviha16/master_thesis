...
class DQN:
    ...
    def train(self):
        for epoch in range(self.epochs):
            ...
            with torch.no_grad():
                ...
                #next_q_vals = self.policy.predict(self.replay_buffer.sampled_next_obs[:, -1, :])  # next_obs?
    ...
    def learn(self, nr_of_episodes):
        ...
        for episode in tqdm(range(nr_of_episodes)):
            ...
            if episode % self.test_freq == 0:
                print(f'Training_reward: {episode_reward}, Exploration probability: {self.exploration_prob}')

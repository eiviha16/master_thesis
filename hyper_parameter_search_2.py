...
def objective(config):
    ...
    _config = {'comment': '--With counter feedback--', 'algorithm': 'TM_DDPG_2', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'update_grad': config.update_grad, 'gamma': config.gamma,
...
def main():
    wandb.init(project="TAC_a_final_2")
...
sweep_id = wandb.sweep(sweep=sweep_configuration, project="TAC_a_final_2")

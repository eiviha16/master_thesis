...
def objective(config):
    ...
    _config = {
        'algorithm': 'Double_TMQN', 'soft_update_type': 'soft_update_2', 'nr_of_clauses': config.nr_of_clauses, 'T': int(config.t * config.nr_of_clauses),
...
def main():
    wandb.init(project="DTMQN-type-b")
...
sweep_id = wandb.sweep(sweep=sweep_configuration, project="DTMQN-type-b")

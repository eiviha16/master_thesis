...
def objective(config):
    ...
    _config = {
        'algorithm': 'n-step_Double_TMQN', "n_steps": config.n_steps, 'soft_update_type': 'soft_update_2', 'nr_of_clauses': config.nr_of_clauses, 'T': int(config.nr_of_clauses * config.t),
...
def main():
    wandb.init(project="n-step Double TMQN")
...
sweep_id = wandb.sweep(sweep=sweep_configuration, project="n-step Double TMQN")

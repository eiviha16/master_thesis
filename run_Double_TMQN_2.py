...
config = {'comment': "Q-value on action", 'soft_update_type': 'soft_update_2', 'algorithm': 'Double_TMQN', 'nr_of_clauses': 1100, 'T': int(1100 * 0.97), 's': 7.68, 'y_max': 70, 'y_min': 20, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 14, 'gamma': 0.967, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 6500, 'batch_size': 48, 'epochs': 2, 'test_freq': 1, "save": True, "seed": 42, "min_feedback_p": 1.0, 'dynamic_memory': False, 'number_of_state_bits_ta': 5, 'update_grad': 0, 'update_freq': 9}

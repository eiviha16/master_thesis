...
config = {'algorithm': 'TMQN', 'nr_of_clauses': 1040, 'T': int(1040 * 0.26), 's': 8.9, 'y_max': 75, 'y_min': 20, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 13, 'gamma': 0.992, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 5500, 'batch_size': 112, 'epochs': 3, 'test_freq': 1, "save": True, "seed": 42, 'number_of_state_bits_ta': 8}
print(config)

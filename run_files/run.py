...
config = {'algorithm': 'DQN', 'gamma': 0.99, 'c':  1, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 50_000, 'batch_size': 256, 'epochs': 8, 'hidden_size': 64, 'learning_rate': 0.001, 'test_freq': 1, 'threshold_score': 450, "save": False}
print(config)
random.seed(42)
np.random.seed(42)

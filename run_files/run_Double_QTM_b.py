...
config = {"env_name": "acrobot", 'algorithm': 'Double_QTM_b', 'soft_update_type': 'soft_update_b',
          ...
          'y_max': -5, 'y_min': -55, 'device': 'CPU', 'bits_per_feature': 8, 'gamma': 0.959, 'epsilon_init': 0.7,
          'epsilon_decay': 0.004, 'buffer_size': 9500, 'batch_size': 80, 'sampling_iterations': 4, 'test_freq': 1,

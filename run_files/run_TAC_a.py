...
config = {"env_name": "cartpole", 'algorithm': 'TAC_a', 'soft_update_type': 'soft_update_a', 'epsilon_init': 0.9, 'epsilon_decay': 0.001, 'clause_update_p': 0.884, 'gamma': 0.99, 'buffer_size': 9500, 'actor': {'nr_of_clauses': 1700, 'T': 1054, 's': 6.180000000000005, 'device': 'CPU', 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 8}, 'critic': {'max_update_p': 0.096, 'nr_of_clauses': 1900, 'T': 684, 's': 5.340000000000003, 'y_max': 100, 'y_min': 15, 'device': 'CPU', 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 7}, 'batch_size': 3, 'sampling_iterations': 112, 'test_freq': 5, 'save': True, 'threshold': 20, 'dataset_file_name': 'cartpole_obs_data'}
print(config)

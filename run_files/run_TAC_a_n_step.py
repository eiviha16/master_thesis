...
config = {"env_name": "cartpole", 'algorithm': 'TAC_a', 'soft_update_type': 'soft_update_a', "n_steps": 20, 'epsilon_init': 0.9, 'epsilon_decay': 0.001,  "epsilon_min": 0, "train_freq": 100, 'clause_update_p': 0.084, 'gamma': 0.99, 'buffer_size': 100000, 'actor': {'nr_of_clauses': 1200, 'T': 854, 's': 6.180000000000005, 'device': 'CPU', 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 4}, 'critic': {'max_update_p': 0.096, 'nr_of_clauses': 1500, 'T': 1084, 's': 3.340000000000003, 'y_max': 100, 'y_min': 15, 'device': 'CPU', 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 3}, 'sample_size': 128, 'test_freq': 5, 'save': True, 'threshold': 20, 'dataset_file_name': 'cartpole_obs_data'}
print(config)

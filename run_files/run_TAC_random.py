...
#config = {'env_name': "acrobot", 'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.8999999999999999, 'exploration_prob_decay': 0.006, 'update_grad': 0.53, 'gamma': 0.987, 'buffer_size': 5500, 'actor': {'nr_of_clauses': 1060, 'T': 116, 's': 2.610000000000001, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 7, 'seed': 42, 'number_of_state_bits_ta': 9}, 'critic': {'max_update_p': 0.005, 'nr_of_clauses': 1450, 'T': 696, 's': 9.140000000000008, 'y_max': -5, 'y_min': -80, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 11, 'seed': 42, 'number_of_state_bits_ta': 8}, 'batch_size': 48, 'epochs': 7, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}
#config = {'env_name': "acrobot", 'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.7999999999999999, 'exploration_prob_decay': 0.005, 'update_grad': 0.906, 'gamma': 0.946, 'buffer_size': 5500, 'actor': {'nr_of_clauses': 1400, 'T': 1316, 's': 5.260000000000003, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 13, 'seed': 42, 'number_of_state_bits_ta': 8}, 'critic': {'max_update_p': 0.084, 'nr_of_clauses': 1000, 'T': 370, 's': 2.4800000000000013, 'y_max': -5, 'y_min': -80, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 9, 'seed': 42, 'number_of_state_bits_ta': 7}, 'batch_size': 112, 'epochs': 2, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}
#config = {'env_name': "acrobot", 'algorithm': 'TAC_random',  'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.5, 'exploration_prob_decay': 0.008, 'update_grad': 0.034, 'gamma': 0.997, 'buffer_size': 2000, 'actor': {'nr_of_clauses': 1800, 'T': 1386, 's': 8.020000000000007, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 6, 'seed': 42, 'number_of_state_bits_ta': 6}, 'critic': {'max_update_p': 0.03, 'nr_of_clauses': 1300, 'T': 1157, 's': 6.200000000000005, 'y_max': -5, 'y_min': -70, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 9, 'seed': 42, 'number_of_state_bits_ta': 6}, 'batch_size': 96, 'epochs': 6, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}
#config = {'env_name': "acrobot", 'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.7999999999999999, 'exploration_prob_decay': 0.005, 'update_grad': 0.906, 'gamma': 0.946, 'buffer_size': 5500, 'actor': {'nr_of_clauses': 1400, 'T': 1316, 's': 5.260000000000003, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 13, 'seed': 42, 'number_of_state_bits_ta': 8}, 'critic': {'max_update_p': 0.084, 'nr_of_clauses': 1000, 'T': 370, 's': 2.4800000000000013, 'y_max': -5, 'y_min': -80, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 9, 'seed': 42, 'number_of_state_bits_ta': 7}, 'batch_size': 112, 'epochs': 2, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}

config = {'env_name': "acrobot", 'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.7, 'exploration_prob_decay': 0.005, 'update_grad': 0.8, 'gamma': 0.937, 'buffer_size': 5000, 'actor': {'nr_of_clauses': 1780, 'T': 1388, 's': 3.5100000000000025, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 6}, 'critic': {'max_update_p': 0.018000000000000002, 'nr_of_clauses': 1850, 'T': 499, 's': 4.5000000000000036, 'y_max': -5, 'y_min': -65, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 9}, 'batch_size': 112, 'epochs': 2, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}

#config = {'algorithm': 'TM_DDPG_2', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.8, 'exploration_prob_decay': 0.007, 'update_grad': 0.257, 'gamma': 0.948, 'buffer_size': 3000, 'actor': {'nr_of_clauses': 980, 'T': 147, 's': 1.3400000000000003, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 12, 'seed': 42, 'number_of_state_bits_ta': 4}, 'critic': {'max_update_p': 0.08700000000000001, 'nr_of_clauses': 1050, 'T': 294, 's': 2.240000000000001, 'y_max': 75, 'y_min': 35, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 8, 'seed': 42, 'number_of_state_bits_ta': 7}, 'batch_size': 48, 'epochs': 7, 'test_freq': 1, 'save': True, 'threshold': 20, 'dataset_file_name': 'observation_data'}
print(config)

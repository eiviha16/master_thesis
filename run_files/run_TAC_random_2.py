...
#config = {'env_name': "acrobot", 'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.7999999999999999, 'exploration_prob_decay': 0.007, 'update_grad': 0.933, 'gamma': 0.933, 'buffer_size': 3500, 'actor': {'nr_of_clauses': 1500, 'T': 255, 's': 4.490000000000003, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 6, 'seed': 42, 'number_of_state_bits_ta': 3}, 'critic': {'max_update_p': 0.034, 'nr_of_clauses': 1250, 'T': 900, 's': 7.900000000000006, 'y_max': -10, 'y_min': -70, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 3}, 'batch_size': 32, 'epochs': 7, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}

#config = {'env_name': "acrobot", 'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.8999999999999999, 'exploration_prob_decay': 0.001, 'update_grad': 0.677, 'gamma': 0.919, 'buffer_size': 2000, 'actor': {'nr_of_clauses': 1000, 'T': 770, 's': 1.6900000000000006, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 10, 'seed': 42, 'number_of_state_bits_ta': 9}, 'critic': {'max_update_p': 0.036000000000000004, 'nr_of_clauses': 1350, 'T': 432, 's': 9.890000000000008, 'y_max': -5, 'y_min': -80, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 13, 'seed': 42, 'number_of_state_bits_ta': 4}, 'batch_size': 96, 'epochs': 5, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}
config = {'env_name': "acrobot", 'algorithm': 'TAC_random',  'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.5, 'exploration_prob_decay': 0.002, 'update_grad': 0.606, 'gamma': 0.925, 'buffer_size': 6500, 'actor': {'nr_of_clauses': 1680, 'T': 1159, 's': 4.860000000000003, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 9}, 'critic': {'max_update_p': 0.015, 'nr_of_clauses': 1700, 'T': 850, 's': 2.270000000000002, 'y_max': -5, 'y_min': -55, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 5, 'seed': 42, 'number_of_state_bits_ta': 6}, 'batch_size': 112, 'epochs': 1, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}
print(config)
...
#config = {'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.8999999999999999, 'exploration_prob_decay': 0.006, 'update_grad': 0.53, 'gamma': 0.987, 'buffer_size': 5500, 'actor': {'nr_of_clauses': 1060, 'T': 116, 's': 2.610000000000001, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 7, 'seed': 42, 'number_of_state_bits_ta': 9}, 'critic': {'max_update_p': 0.005, 'nr_of_clauses': 1450, 'T': 696, 's': 9.140000000000008, 'y_max': -5, 'y_min': -80, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 11, 'seed': 42, 'number_of_state_bits_ta': 8}, 'batch_size': 48, 'epochs': 7, 'test_freq': 1, 'save': True, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}
config = {"env_name": "cartpole", 'algorithm': 'TAC_random', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.8, 'exploration_prob_decay': 0.007, 'update_grad': 0.298, 'gamma': 0.967, 'buffer_size': 7000, 'actor': {'nr_of_clauses': 1000, 'T': 360, 's': 4.980000000000004, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 7, 'seed': 42, 'number_of_state_bits_ta': 5}, 'critic': {'max_update_p': 0.011, 'nr_of_clauses': 1300, 'T': 481, 's': 3.7800000000000025, 'y_max': 60, 'y_min': 35, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 8, 'seed': 42, 'number_of_state_bits_ta': 5}, 'batch_size': 112, 'epochs': 3, 'test_freq': 1, 'save': True, 'threshold': 20, 'dataset_file_name': 'observation_data'}
print(config)
#not tested acrobot {'algorithm': 'TM_DDPG_2', 'soft_update_type': 'soft_update_1', 'exploration_prob_init': 0.7, 'exploration_prob_decay': 0.002, 'update_grad': 0.789, 'gamma': 0.959, 'buffer_size': 1000, 'actor': {'nr_of_clauses': 1600, 'T': 704, 's': 8.590000000000007, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 11, 'seed': 42, 'number_of_state_bits_ta': 4}, 'critic': {'max_update_p': 0.093, 'nr_of_clauses': 1000, 'T': 880, 's': 1.760000000000001, 'y_max': -5, 'y_min': -80, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 12, 'seed': 42, 'number_of_state_bits_ta': 8}, 'batch_size': 16, 'epochs': 4, 'test_freq': 1, 'save': False, 'threshold': -495, 'dataset_file_name': 'acrobot_obs_data'}
#env = gym.make("Acrobot-v1")
env = gym.make("CartPole-v1")

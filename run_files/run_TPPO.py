...
actor = {"max_update_p": 0.016, "min_update_p": 0.0008, 'nr_of_clauses': 1850, 'T': int(1850 * 0.34), 's': 1.76,
         'y_max': 100, 'y_min': 0, 'bits_per_feature': 6, 'number_of_state_bits_ta': 6}
critic = {"max_update_p": 0.075, "min_update_p": 0.0, 'nr_of_clauses': 1340, 'T': int(1340 * 0.78), 's': 1.65,
          'y_max': -1.0, 'y_min': -29.1, 'bits_per_feature': 10, 'number_of_state_bits_ta': 7}
config = {'env_name': "acrobot", 'algorithm': 'TPPO', "n_timesteps": 12, 'gamma': 0.951, 'lam': 0.944, "actor": actor,
          "critic": critic, 'device': 'CPU', 'epochs': 2, 'test_freq': 1, "save": True, "seed": 42,

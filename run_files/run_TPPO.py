...
config = {'env_name': "acrobot", 'algorithm': 'TPPO', "n_timesteps": 12, 'gamma': 0.951, 'lam': 0.944, "actor": actor, "critic": critic, 'device': 'CPU', 'epochs': 2, 'test_freq': 1, "save": True, "seed": 42, "dataset_file_name": "acrobot_obs_data", "threshold": -1000} #"dataset_file_name": "acrobot_obs_data"}"observation_data"

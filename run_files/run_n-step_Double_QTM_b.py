...
config = {"env_name": "acrobot", 'algorithm': 'n_step_Double_QTM_b', 'soft_update_type': 'soft_update_b', 'n_steps': 14,
          'nr_of_clauses': 1860, 'T': 613, 'max_update_p': 0.151, 'min_update_p': 0, 's': 3.6000000000000023,
          'y_max': -10, 'y_min': -70, 'device': 'CPU', 'bits_per_feature': 10, 'gamma': 0.93, 'epsilon_init': 0.7,
          'epsilon_decay': 0.008, "train_freq": 100, "epsilon_min": 0, 'buffer_size': 4000, 'batch_size': 1, 'sample_size': 64, 'test_freq': 1,
          'save': True, 'seed': 42, 'threshold': -495, 'number_of_state_bits_ta': 6, 'update_freq': 3,

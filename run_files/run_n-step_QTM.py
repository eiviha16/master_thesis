...
config = {"env_name": "acrobot", 'algorithm': 'n_step_QTM', 'n_steps': 30, 'nr_of_clauses': 1700, 'T': 1258,
          ...
          'bits_per_feature': 12, 'gamma': 0.983, 'epsilon_init': 0.7, 'epsilon_decay': 0.009000000000000001,
          'buffer_size': 5000, 'threshold': -495, 'batch_size': 96, 'sampling_iterations': 1, 'test_freq': 5,

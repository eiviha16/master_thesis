...
config = {'env_name': 'acrobot', 'n_steps': 28, 'algorithm': 'n_step_DQN', 'c': 0, 'gamma': 0.994, 'buffer_size': 7000, 'batch_size': 96, 'exploration_prob_init': 0.7, 'exploration_prob_decay': 0.005, 'epochs': 8, 'hidden_size': 160, 'learning_rate': 0.00623, 'test_freq': 5, 'save': True}

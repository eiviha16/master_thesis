...
config = {'algorithm': 'n_step_Double_TMQN', 'soft_update_type': 'soft_update_2', 'n_steps': 10, 'nr_of_clauses': 1000, 'T': 800, 's': 9, 'y_max': 60, 'y_min': 40, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 15, 'gamma': 0.99, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 2000, 'batch_size': 64, 'epochs': 2, 'test_freq': 1,  "save": True, 'number_of_state_bits_ta': 10, 'update_grad': 0.05, 'update_freq': 6}

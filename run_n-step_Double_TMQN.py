...
config = {'comment': "Q-value on action",'algorithm': 'n_step_Double_TMQN', 'soft_update_type': 'soft_update_1', 'n_steps': 9, 'nr_of_clauses': 1040, 'T': (1040 * 0.84), 's': 9.0, 'y_max': 65, 'y_min': 35, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 10, 'gamma': 0.977, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 9000, 'batch_size': 16, 'epochs': 5, 'test_freq': 1,  "save": True, 'number_of_state_bits_ta': 7, 'update_grad': 0.62, 'update_freq': 100}

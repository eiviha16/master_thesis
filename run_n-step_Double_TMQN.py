...
config = {'algorithm': 'n_step_Double_TMQN', 'soft_update_type': 'soft_update_1', 'n_steps': 19, 'nr_of_clauses': 1080, 'T': (1080 * 0.64), 's': 9.92, 'y_max': 70, 'y_min': 20, 'max_update_p': 0.05, "min_update_p": 0.0, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 5, 'gamma': 0.966, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 500, 'batch_size': 96, 'epochs': 4, 'test_freq': 1,  "save": True, 'number_of_state_bits_ta': 8, 'update_grad': 0.129, 'update_freq': 9999999, "dataset_file_name": "observation_data"}

...
config = {'comment': "Q-value on action",'algorithm': 'n_step_Double_TMQN', 'soft_update_type': 'soft_update_2', 'n_steps': 30, 'max_update_p': 0.05, "min_update_p": 0.0001,'nr_of_clauses': 1120, 'T': (1120 * 0.97), 's': 8.75, 'y_max': -50, 'y_min': -100, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 13, 'gamma': 0.979, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 7500, 'batch_size': 32, 'epochs': 2, 'test_freq': 1,  "save": True, 'number_of_state_bits_ta': 6, 'update_grad': 0.00, 'update_freq': 8,  "dataset_file_name": "acrobot_obs_data"}# "observation_data"}

...
config = {'algorithm': 'n_step_TMQN', 'n_steps': 16, 'nr_of_clauses': 960, 'T': int(960 * 0.86), 's': 5.37, 'y_max': 75, 'y_min': 30, 'device': 'CPU', 'weighted_clauses': False, 'bits_per_feature': 5, 'gamma': 0.987, 'exploration_prob_init': 1.0, 'exploration_prob_decay': 0.001, 'buffer_size': 9500, 'batch_size': 96, 'epochs': 6, 'test_freq': 1,  "save": True, 'dynamic_memory': False, 'number_of_state_bits_ta': 8}

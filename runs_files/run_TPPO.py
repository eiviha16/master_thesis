...
"""
actor = {"max_update_p": 0.099, "min_update_p": 0.0009, 'nr_of_clauses': 880, 'T': int(880 * 0.46), 's': 3.63, 'y_max': 100, 'y_min': 0,  'bits_per_feature': 6, 'number_of_state_bits_ta': 7}
critic = {"max_update_p": 0.016, "min_update_p": 0.0, 'nr_of_clauses': 1470, 'T': int(1470 * 0.49), 's': 2.25, 'y_max': 34.5, 'y_min': 0.8,  'bits_per_feature': 10, 'number_of_state_bits_ta': 7}
config = {'env_name': "cartpole", 'algorithm': 'TPPO', "n_timesteps": 430, 'gamma': 0.948, 'lam': 0.969, "actor": actor, "critic": critic, 'device': 'CPU', 'weighted_clauses': False,  'batch_size': 64, 'epochs': 4, 'test_freq': 1, "save": True, "seed": 42, "dataset_file_name": "observation_data", "threshold": -1000} #"dataset_file_name": "acrobot_obs_data"}

...
class PPO_c():
    def __init__(self, config):
        ...
        self.model = DQN("MlpPolicy", self.env, gamma=0.99, policy_kwargs={"net_arch": [256, 256]}, learning_rate=0.00063, seed=42, verbose=0)#, n_steps=16)
...
if __name__ == "__main__":
    ...
    config = {"env_name": "acrobot", "algorithm": "DQN", "run": "run_100"}
    ppo = PPO_c(config)
    ppo.learn(10)
